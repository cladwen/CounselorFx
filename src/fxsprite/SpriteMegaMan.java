 ...
 */
public class SpriteMegaMan extends ImageView {
     ...
     */
    public SpriteMegaMan(Image sheet, int width, int height) { // Not recommended
        super(sheet);
     ...
     * @param height the height of a single sprite cell
     */
    public SpriteMegaMan(String sheet, int width, int height) {
        super(images.containsKey(sheet) ? images.get(sheet) : new Image(SpriteMegaMan.class.getClassLoader().getResourceAsStream(sheet)));
    ...
    public class SpriteAnimation extends Transition {
        ...
        protected void interpolate(double dt) {
            double yoffset = SpriteMegaMan.this.rect.getHeight() * this.row;
            double xoffset = SpriteMegaMan.this.rect.getWidth() * (int) (Math.round((this.cols - 1) * dt));
            SpriteMegaMan.this.setViewport(new Rectangle2D(SpriteMegaMan.this.rect.getMinX() + xoffset,
                    SpriteMegaMan.this.rect.getMinY() + yoffset,
                    SpriteMegaMan.this.rect.getWidth(),
                    SpriteMegaMan.this.rect.getHeight()));
        }
    }
}
